...
只读 import code/problem4_fvm_bdf；不改其任何文件。运行：
...
for _stream in (sys.stdout, sys.stderr):
    try:
        ...
        pass
if str(ROOT / "code" / "problem4_mass_closure") not in sys.path:
    sys.path.insert(0, str(ROOT / "code" / "problem4_mass_closure"))
...
def main() -> None:
    ...
    verification = {
        "source": {
            ...
            "solver_dir": str(ROOT / "code" / "problem4_fvm_bdf"),
        },
        "archived_references": {
